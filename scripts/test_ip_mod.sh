...
# This Bash script manages creates and deletes modified iptables rules within the network namespace ns1, while also monitoring their usage and storing observed statistics.
...
RSF=result/nft2/wrk/run${RSF} # the path to where the data will be stored.
